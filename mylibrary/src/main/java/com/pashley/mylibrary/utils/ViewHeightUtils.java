 ...
 * <li>{@link ViewHeightUtils#getListViewHeightBasedOnChildren(ListView)}</li>
 * <li>{@link ViewHeightUtils#getAbsListViewHeightBasedOnChildren(AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>set view height</strong>
 * <li>{@link ViewHeightUtils#setViewHeight(View, int)} set view height</li>
 * <li>{@link ViewHeightUtils#setListViewHeightBasedOnChildren(ListView)}</li>
 * <li>{@link ViewHeightUtils#setAbsListViewHeightBasedOnChildren(AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>get other info</strong>
 * <li>{@link ViewHeightUtils#getGridViewVerticalSpacing(GridView)} get GridView vertical spacing</li>
 * </ul>
 * <ul>
 * <strong>set other info</strong>
 * <li>{@link ViewHeightUtils#setSearchViewOnClickListener(View, OnClickListener)}</li>
 * </ul>
 * 
